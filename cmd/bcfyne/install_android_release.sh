...
(cd $GOPATH/src/aletheiaware.com/bcfynego/cmd/bcfyne && fyne release -os android -appID com.aletheiaware.bc -appBuild 1 -appVersion 1.2.1 -keyStore=$GOPATH/src/aletheiaware.com/bcfynego/private/BC.keystore -name BC)
